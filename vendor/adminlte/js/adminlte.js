...
+(function ($) {
  ...
  BoxRefresh.prototype._setUpListeners = function () {
    $(this.element).on('click', this.options.trigger, (event) => {
...
+(function ($) {
  ...
  BoxWidget.prototype.expand = function () {
    ...
    const expandingEvent = $.Event(Event.expanding);
    const { collapseIcon } = this.options;
    const { expandIcon } = this.options;
  ...
  BoxWidget.prototype.collapse = function () {
    ...
    const collapsingEvent = $.Event(Event.collapsing);
    const { collapseIcon } = this.options;
    const { expandIcon } = this.options;
  ...
  BoxWidget.prototype.remove = function () {
    ...
    const removingEvent = $.Event(Event.removing);
  ...
  Layout.prototype.activate = function () {
    ...
    if (!this.bindedResize) {
      $(window).resize(() => {
        ...
        $(`${Selector.logo}, ${Selector.sidebar}`).one('webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend', () => {
          this.fix();
          this.fixSidebar();
        });
      });
